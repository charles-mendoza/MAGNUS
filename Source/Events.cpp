...
void Caller::Call(Controls::Control* pThis)
{
	static Magnus::Event::Information info;
	info.Control = pThis;
	Call(pThis, info);
}

void Caller::Call(Controls::Control* pThis, Magnus::Event::Info information)
{
